...
public class VersionService {
    public VersionDTO createVersion(String project, String version, String type) {
        ...
        int id = VersionDAO.insert(new VersionDatabaseDTO(
                version,
                type
        ));
        return new VersionDTO(id, version, type);
    }
